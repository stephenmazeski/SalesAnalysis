...
Merged_Cut$DaysDelayed <- with(Merged_Cut, ifelse(OrderDayoftheWeek == 1& Product != 'O', DaysDelayed - 1, DaysDelayed))
Merged_Cut$DaysDelayed <- with(Merged_Cut, ifelse(OrderDayoftheWeek == 7 & AddressType == 'R' & Product != 'O', DaysDelayed - 1, DaysDelayed))
Merged_Cut$DaysDelayed <- with(Merged_Cut, ifelse(OrderDayoftheWeek == 7 & AddressType == 'C'& Product != 'O', DaysDelayed - 1, DaysDelayed))
...
ggplot(data=MergedSplit,aes(x=OrderDayoftheWeek,y=AvgDayShip))+geom_point()+aes(colour=Product, shape = AddressType)#+facet_wrap(~Product,ncol=4) 
